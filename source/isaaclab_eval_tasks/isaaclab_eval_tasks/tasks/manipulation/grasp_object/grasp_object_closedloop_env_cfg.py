...
from isaaclab_eval_tasks.tasks.manipulation.grasp_object.grasp_object_base_env_cfg import (
    GraspObjectBaseEnvCfg,
)
...
@configclass
class GraspObjectClosedLoopEnvCfg(GraspObjectBaseEnvCfg):
