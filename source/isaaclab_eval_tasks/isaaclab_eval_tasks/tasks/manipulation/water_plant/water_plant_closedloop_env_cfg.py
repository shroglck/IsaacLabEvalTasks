...
from isaaclab_eval_tasks.tasks.manipulation.water_plant.water_plant_base_env_cfg import (
    WaterPlantBaseEnvCfg,
)
...
@configclass
class WaterPlantClosedLoopEnvCfg(WaterPlantBaseEnvCfg):
