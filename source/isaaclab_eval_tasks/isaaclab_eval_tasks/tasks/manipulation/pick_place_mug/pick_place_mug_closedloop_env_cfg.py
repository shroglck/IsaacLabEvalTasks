...
from isaaclab_eval_tasks.tasks.manipulation.pick_place_mug.pick_place_mug_base_env_cfg import (
    PickPlaceMugBaseEnvCfg,
)
...
@configclass
class PickPlaceMugClosedLoopEnvCfg(PickPlaceMugBaseEnvCfg):
